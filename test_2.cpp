...
int main()
{
	vector<information> v_info = {
		{ 12351346612, "Péter", "Valami", "asdasdasd@gmail.com" },
		{ 06123571236, "Pablo", "Escobar", "asdasdasd@hotmail.com" },
		{ 13782369333, "Kredenc", "Nemtudom", "asdasdas@hotmail.com" },
		{ 12357123578, "Kakao", "asdasd", "asdsasdasd@gmail.com" },
		{ 86347894568, "JuiceWRLD", "Sarbak", "asdsasd@gmail.com" }
	};
